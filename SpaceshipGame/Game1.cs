...
namespace SpaceshipGame
{
    public class Game1 : Game
    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            _spriteBatch.Draw(shipSprite, new Vector2(player.position.X - 32, player.position.Y - 50), Color.White);
            ...
            _spriteBatch.DrawString(timerFont, $"Time: {Math.Floor(gameController.totalTime)}", new Vector2(3,3), Color.White);
            _spriteBatch.End();
